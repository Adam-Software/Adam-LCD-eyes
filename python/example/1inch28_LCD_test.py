...
#    draw.text((40, 50), 'ROBOT LLC', fill = (128,255,128),font=Font2)
    text= u"ADAM"
...
#    draw.line([(120, 120),(120 ,210)], fill = "RED",width = 3)
    ...
    while 1:
        ...
        image = Image.open('../pic/giphy10.jpg')
        im_r=image.rotate(0)
        disp.ShowImage(im_r)
        time.sleep(3)
        logging.info("show image")
        image = Image.open('../pic/giphy11.jpg')
        im_r = image.rotate(0)
        disp.ShowImage(im_r)
        time.sleep(0.1)
        logging.info("show image")
        image = Image.open('../pic/giphy12.jpg')
        im_r = image.rotate(0)
        disp.ShowImage(im_r)
        time.sleep(0.1)
        logging.info("show image")
        image = Image.open('../pic/giphy13.jpg')
        im_r = image.rotate(0)
        disp.ShowImage(im_r)
        time.sleep(0.1)
        logging.info("show image")
        image = Image.open('../pic/giphy14.jpg')
        im_r = image.rotate(0)
        disp.ShowImage(im_r)
        time.sleep(0.1)
        logging.info("show image")
        image = Image.open('../pic/giphy15.jpg')
        im_r = image.rotate(0)
        disp.ShowImage(im_r)
        time.sleep(0.05)
        logging.info("show image")
        image = Image.open('../pic/giphy16.jpg')
        im_r = image.rotate(0)
        disp.ShowImage(im_r)
        time.sleep(0.05)
    # Clear display.
